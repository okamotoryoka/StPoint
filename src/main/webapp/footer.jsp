...
<div class="container">
    ...
    <aside class="sidebar" style="width: 220px; min-width: 220px; padding: 20px 10px 20px 20px; box-sizing: border-box;">
        ...
        <ul style="list-style: none; padding-left: 0; margin: 0; line-height: 2.0; width: 100%;">
            ...
            <li style="padding-left: 20px; margin-bottom: 8px;"><a href="${pageContext.request.contextPath}/ScoreRegist.action">成績登録</a></li>
            <li style="padding-left: 20px; margin-bottom: 16px;"><a href="${pageContext.request.contextPath}/ScoreSearch.action">成績参照</a></li>
