...
<head>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .login-title { font-size: 42px; margin-bottom: 30px; font-family: "Yu Gothic","メイリオ", serif; letter-spacing: 3px; font-weight: bold; text-shadow: 0 0 8px rgba(255,255,255,0.5); white-space: nowrap; }
