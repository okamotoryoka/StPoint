...
<tr>
<th>科目コード</th>
<td><%= data.get("subject_cd") %></td>
</tr>
<tr>
<th>得点</th>
<td><input type="number" name="point" value="<%= data.get("point") %>"></td>
</tr>
<tr>
<th>学校コード</th>
<td><%= data.get("school_cd") %></td>
</tr>
<tr>
<th>クラス番号</th>
<td><input type="text" name="class_num" value="<%= data.get("class_num") %>"></td>
</tr>
</table>
<br>
